        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-accent transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><Link to="/services" className="hover:text-accent transition-colors">Medical & Healthcare</Link></li>
              <li><Link to="/services" className="hover:text-accent transition-colors">Industrial Facilities</Link></li>
              <li><Link to="/services" className="hover:text-accent transition-colors">Green Cleaning</Link></li>
              <li><Link to="/services" className="hover:text-accent transition-colors">Specialty Services</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><Link to="/admin" className="hover:text-accent transition-colors">Client Portal</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                <svg className="w-5 h-5 text-accent shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
